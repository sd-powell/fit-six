...
| 8 | Deleting a product from the product detail page triggered immediate deletion with only a toast notification and no confirmation modal, unlike the product list page. | Added a Bootstrap confirmation modal to the product detail page, matching the design and behavior of the modal used on the products list. This ensures users confirm before deleting any item. | ![Screenshot](documentation/testing/bugs/delete-modal-product-detail.webp) |
